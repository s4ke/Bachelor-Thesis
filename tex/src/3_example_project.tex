...
\fixme{"Zeitstrahldiagramm", das den kompletten Ablauf aufzeigt (erst Standalone, dann JPA integration, dann automatic indexing feature, etc.), im Outlook dann nochmal darauf hinweisen, dass noch die Merge Arbeit eigentlich noch dazugehört}
