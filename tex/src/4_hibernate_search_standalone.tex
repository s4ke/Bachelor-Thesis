...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.6]{images/hibernate_search_genericjpa_complete_architecture.pdf}
...
\textcolor{red}{now let's talk about what has to be changed. Am Beispiel und für jedes Feature einzeln zeigen}
