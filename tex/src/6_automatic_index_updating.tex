...
\end{lstlisting}
\noindent
With these two queries for each update table we are able to keep the index up-to-date efficiently and also make sure that no event is handled twice.
...
\section{Usage of Hibernate Search GenericJPA}
